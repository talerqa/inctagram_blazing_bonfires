...
import desktopImage from '@/shared/assets/icons/devices/light-icons/desktop.svg'
import mobileImage from '@/shared/assets/icons/devices/light-icons/mobile.svg'
import logoutImg from '@/shared/assets/icons/logout/logout.svg'
import { Button, ButtonSize, ButtonTheme } from '@/shared/ui'
import { IconDevice } from '@/shared/ui/icon-device/icon-device'
