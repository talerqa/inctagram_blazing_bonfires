...
export type ProfileImagesFragmentFragment = {
  __typename?: 'ImagePost'
  id?: number | null
  createdAt?: any | null
  url?: string | null
  ...
  height?: number | null
  fileSize?: number | null
} & { ' $fragmentName'?: 'ProfileImagesFragmentFragment' }
...
export const ProfileImagesFragmentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ProfileImagesFragment' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'ImagePost' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<ProfileImagesFragmentFragment, unknown>
